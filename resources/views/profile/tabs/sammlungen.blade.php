<div class="flex flex-col space-y-12 mr-24">
    ...
    @if($viewingCollection && !$isEditingCollection)
        <div class="space-y-12">
            <p class="text-indigo-400 text-sm"><a href="/profile" class="font-light cursor-pointer">Listen</a> / <a
                    href="/profile" class="font-semibold cursor-pointer">{{$viewingCollection->name}}</a></p>
                ...
                <div class="w-1/2">
                    <label class="inline-flex items-center cursor-pointer">
                        <input
                            ...
                            class="sr-only peer"
                        >
                        <div class="relative w-19 h-6 bg-input-dark/85 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-indigo-700"></div>
    ...
    @if($isEditing && !$viewingCollection)
        <div class="space-y-12">
            ...
            <div class="">
                ...
                <div class="mt-5">
                    <x-carousel-pagination-new :items="$this->movies" :per-page="7">
                        <div class="flex scrollbar-hide overflow-x-auto scroll-smooth snap-x snap-mandatory">
